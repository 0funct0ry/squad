...
func TestQueryHandlers(t *testing.T) {
	...
	srv := NewServer(database, ":memory:", false, false, false, "127.0.0.1", 7072, "info") // write = false
	...
	srvWrite := NewServer(database, ":memory:", true, false, false, "127.0.0.1", 7072, "info") // write = true
